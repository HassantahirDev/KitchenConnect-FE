...
const Testimonials = () => {
  return (
    <Box sx={{ py: 8, px: 4, textAlign: 'center', backgroundColor: '#f5f5f5', fontFamily: 'Outfit' }}>
      <Typography variant="h4" sx={{ mb: 4, fontWeight: 900, fontFamily: 'Outfit'}}>
              ...
              <CustomCard>
                <CardContent sx={{ textAlign: 'center' }}>
                  <Avatar
                    ...
                    sx={{ width: 80, height: 80, mb: 2, mx: 'auto', border: '3px solid #eee' }}
                  />
                  <Typography variant="h6" sx={{ mb: 1, fontWeight: 500, fontFamily: 'Outfit' }}>
                    {testimonial.name}
                  </Typography>
